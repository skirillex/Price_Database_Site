...
import '../main.dart';
import 'TopPriceDropsData.dart';
import 'TpdGetImageHelperClass.dart';
import 'TpdGetItemNameAndLinkHelperClass.dart';
...
class _TopPriceDropItemsState extends State<TopPriceDropItems>{
  ...
  Future<TopPriceDropsData> fetchPriceDropItems() async {
    final response = await http.get("http://127.0.0.1:5000/api/v1/resources/topprices/");
